...
DIR_TO_ADD = Path("AUPSA_ACE_JN_Correspondencia Presidencia/ACE_JN_62_001 a 62_004/AUPSA_ACE_JN_0062_001")
...
def indexar_todos_los_pdfs():
    ...
    chunk_size = 500
    for ruta_pdf in DIR_TO_ADD.rglob("*.pdf"):
        try:
            ...
            for i, chunk in enumerate(chunks):
                ...
                collection.add(
                    ...
                    metadatas=[{
                        ...
                        "path": str(ruta_pdf.relative_to(BASE_PATH))  
                    }]
                )
...
if __name__ == "__main__":
    ...
    while True:
        ...
        for nombre, ruta in sorted(fuentes):
            print(f"  - {nombre} ({ruta})")
